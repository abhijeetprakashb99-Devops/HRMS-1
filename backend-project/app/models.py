...
class Client(models.Model):
    ...
    # DOCUMENT
    requirement_document = models.FileField(upload_to='client_docs/', blank=True, null=True)
...
class Project(models.Model):
    ...
    team_leader = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='led_projects')
